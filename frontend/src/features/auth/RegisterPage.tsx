    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fade-in">
      ...
      >
        ...
        <div className="px-8 pt-8 pb-7 space-y-5">
          {/* ── Header ── */}
          <div>
            <h1 className="text-2xl font-bold text-gray-900 leading-tight">Register</h1>
          ...
          <form onSubmit={handleRegister} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              <label htmlFor="register-username" className="block text-sm font-semibold text-gray-800">
                Username
              </label>
              <input
                ...
                className={`w-full px-3.5 py-2.5 text-sm text-gray-900 bg-white border rounded-lg outline-none placeholder-gray-400
                  ...
                  ${errors.username ? 'border-red-400 ring-2 ring-red-200' : 'border-gray-300 hover:border-gray-400'}`}
              />
              {errors.username && (
            ...
            {/* Email Address */}
            <div className="space-y-1.5">
              <label htmlFor="register-email" className="block text-sm font-semibold text-gray-800">
                Email Address
              </label>
              <input
                id="register-email"
            ...
            {/* Password */}
            <div className="space-y-1.5">
              <label htmlFor="register-password" className="block text-sm font-semibold text-gray-800">
                Password
              </label>
